...
impl Punct {
    ...
    fn get_binary_operator_data(self, allow_comma: bool) -> Option<BinaryOperatorData> {
        match self {
            ...
            Punct::TripleGreaterThanEqual => Some(BinaryOperatorData{precedence: 3, association: Association::Right}),
            Punct::Ellipsis => None,
            ...
            Punct::TripleGreaterThan => Some(BinaryOperatorData{precedence: 12, association: Association::Left}),
            Punct::DoubleLessThanEqual => Some(BinaryOperatorData{precedence: 3, association: Association::Right}),
            Punct::DoubleGreaterThanEqual => Some(BinaryOperatorData{precedence: 3, association: Association::Right}),
            ...
            Punct::DoubleLessThan => Some(BinaryOperatorData{precedence: 12, association: Association::Left}),
            Punct::DoubleGreaterThan => Some(BinaryOperatorData{precedence: 12, association: Association::Left}),
